...
import { ObjectUtils } from "../../shared/utilities/index.js";
...
export default class ValidationMiddlewares {
  ...
  static createRequestDataValidator = (schema) => (req, res, next) => {
    ...
    const joiKeys = ["headers", "params", "query", "body"];
    ...
    const { value, error } = Joi.compile(currentSchema)
      .prefs(joiOptions)
      .validate(currentObject);
